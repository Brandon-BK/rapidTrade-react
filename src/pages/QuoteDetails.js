...
const QuoteDetails = () => {
  ...
  const DUMMMY_QUOTES = [
    { id: 'q1', author: 'Brandon Kisibu', text: 'Learning react is fun!!' },
    { id: 'q2', author: 'Michee Bakanda', text: 'Learning react is fun!!' },
    { id: 'q3', author: 'Dercio Maduna', text: 'Learning react is fun!!' },
    { id: 'q3', author: 'Schadrack Botomber', text: 'Learning react is fun!!' },
  ]
